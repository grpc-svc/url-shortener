...
func (_mock *MockURLSaver) SaveURL(ctx context.Context, alias string, originalURL string, ownerEmail string) error {
	ret := _mock.Called(ctx, alias, originalURL, ownerEmail)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string) error); ok {
		r0 = returnFunc(ctx, alias, originalURL, ownerEmail)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - originalURL string
//   - ownerEmail string
func (_e *MockURLSaver_Expecter) SaveURL(ctx interface{}, alias interface{}, originalURL interface{}, ownerEmail interface{}) *MockURLSaver_SaveURL_Call {
	return &MockURLSaver_SaveURL_Call{Call: _e.mock.On("SaveURL", ctx, alias, originalURL, ownerEmail)}
}

func (_c *MockURLSaver_SaveURL_Call) Run(run func(ctx context.Context, alias string, originalURL string, ownerEmail string)) *MockURLSaver_SaveURL_Call {
...
func (_c *MockURLSaver_SaveURL_Call) RunAndReturn(run func(ctx context.Context, alias string, originalURL string, ownerEmail string) error) *MockURLSaver_SaveURL_Call {
	_c.Call.Return(run)
	return _c
}
